...
public class Lexer {
	...
	/*
	 * This function loops over all the characters that 
	 * the are entered. This is used for either a one line
	 * comment or multiline comment, depending on the value
	 * of the boolean variable isMultiline.
	 */
